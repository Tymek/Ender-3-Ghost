...
#if TEMP_SENSOR_PINDA == -4
  #define HEATER_PINDA_USES_AD8495
#elif TEMP_SENSOR_PINDA == -3
  #error "MAX31855 Thermocouples (-3) not supported for TEMP_SENSOR_PINDA."
#elif TEMP_SENSOR_PINDA == -2
  #error "MAX6675 Thermocouples (-2) not supported for TEMP_SENSOR_PINDA."
#elif TEMP_SENSOR_PINDA == -1
  #define HEATER_PINDA_USES_AD595
#elif TEMP_SENSOR_PINDA > 0
  #define THERMISTORPINDA TEMP_SENSOR_PINDA
  #define HEATER_PINDA_USES_THERMISTOR
#endif
...
#define HAS_TEMP_SENSOR (HAS_TEMP_HOTEND || HAS_HEATED_BED || HAS_TEMP_CHAMBER || HAS_TEMP_PINDA)
