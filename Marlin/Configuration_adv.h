...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      310  // (mm) The length of filament for a complete unload.
  ...
  #define ADVANCED_PAUSE_PURGE_LENGTH         90  // (mm) Length to extrude after loading.
